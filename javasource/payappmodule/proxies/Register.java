...
public class Register implements com.mendix.systemwideinterfaces.core.IEntityProxy
{
	private final com.mendix.systemwideinterfaces.core.IMendixObject registerMendixObject;
	 ...
	 */
	public static final java.lang.String entityName = "PayAppModule.Register";
	...
	public Register(com.mendix.systemwideinterfaces.core.IContext context)
	{
		this(context, com.mendix.core.Core.instantiate(context, entityName));
	}

	protected Register(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject registerMendixObject)
	{
		if (registerMendixObject == null) {
			throw new java.lang.IllegalArgumentException("The given object cannot be null.");
		}
		if (!com.mendix.core.Core.isSubClassOf(entityName, registerMendixObject.getType())) {
			throw new java.lang.IllegalArgumentException(String.format("The given object is not a %s", entityName));
		}	

		this.registerMendixObject = registerMendixObject;
	 ...
	 */
	public static payappmodule.proxies.Register initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new payappmodule.proxies.Register(context, mendixObject);
	}

	public static payappmodule.proxies.Register load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return payappmodule.proxies.Register.initialize(context, mendixObject);
	}

	public static java.util.List<payappmodule.proxies.Register> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		return com.mendix.core.Core.createXPathQuery(String.format("//%1$s%2$s", entityName, xpathConstraint))
			.execute(context)
			.stream()
			.map(obj -> payappmodule.proxies.Register.initialize(context, obj))
	...
	public boolean equals(Object obj)
	{
		...
		{
			final payappmodule.proxies.Register that = (payappmodule.proxies.Register) obj;
